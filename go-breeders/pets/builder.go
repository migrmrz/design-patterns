...
// Everything except the Build() function return the type *Pet because we are
...
// SetSpecies sets the species for our pet, and return a *Pet.
...
// SetWeight sets the maximum weight for our pet, and return a *Pet.
